...
class DashboardController extends Controller {
    public function index(Request $request) {
        $technics_query = BusinessFactories::with('reports')->where('business_id', $request->user()->business->id);
...
//        dd($reports_array);
        ...
        $business_factory_views_query = Report::where('action', 'business_factory_views')->where('business_id', $request->user()->business->id);
    ...
    public function create_pdf() {
        $technics_query = BusinessFactories::with('reports')->where('business_id', 1);
...
//        dd($reports_array);
        ...
        $business_factory_views_query = Report::where('action', 'business_factory_views')->where('business_id', 1);
        $business_profile_views_query = Report::where('action', 'business_profile_views')->where('business_id', 1);
        $email_views_query = Report::where('action', 'email_views')->where('business_id', 1);
        $phone_views_query = Report::where('action', 'phone_views')->where('business_id', 1);
        $www_views_query = Report::where('action', 'www_views')->where('business_id', 1);
        $contact_person_phone_views_query = Report::where('action', 'contact_person_phone_views')->where('business_id', 1);
...
//        dd($reports_array);
        ...
        return view('business.dashboard.pdf', [
            'reports_array'=>$reports_array,
            'business_factory_views' => $business_factory_views,
            'business_profile_views' => $business_profile_views,
            'email_views' => $email_views,
