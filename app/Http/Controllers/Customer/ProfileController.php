<?php
    ...
    class ProfileController extends Controller {
        ...
        public function index() {
            ...
            return view('customer.settings.profile.index', ['profile' => $profile]);
        ...
        public function changePhone(Request $request) {
            ...
            if($authLoginCode->code == $this->code) {
                ...
                $notificationText = NotificationMessage::select('id')->where('action','customer.phone.changed')->first();
        ...
        public function update(Request $request) {
            ...
            if($profile->address == null || $profile->address !== $request->address ) {
                $notificationText = NotificationMessage::select('id')->where('action', $profile->address == null ? 'customer.address.adding' : 'customer.address.changed')->first();
                $notification = new Notification;
