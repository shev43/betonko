<?php
    return [
        'error_data' => 'Ошибка получения данных', 'test_mode' => 'Режим тестирования отправки',
        'empty_text' => 'Текст сообщения не указан', 'response_status' => [
            //0
            'OK' => 'Запрос обработан успешно', //1
            'PONG' => 'Успешный результат вызова метода ping', //103
            'REQUIRED_TOKEN' => 'Отсутствует токен аутентификации', //104
            'REQUIRED_CONTENT' => 'Отсутствуют данные запроса', //105
            'REQUIRED_AUTH' => 'Аутентификация не пройдена, не верный токен', //106
            'REQUIRED_ACTIVE_USER' => 'Пользователь заблокирован, работа с API невозможна до разблокировки', //200
            'REQUIRED_MESSAGE_SENDER' => 'Отсутствует или пустой параметр отправителя сообщения', //201
            'REQUIRED_MESSAGE_TEXT' => 'Отсутствует или пустой параметр текста сообщения', //202
            'REQUIRED_MESSAGE_RECIPIENT' => 'Отсутствует или пустой список получателей сообщения', //203
            'REQUIRED_BALANCE' => 'Не достаточно кредитов на балансе для создания рассылки', //204
            'REQUIRED_MESSAGE_BUTTON' => 'Отсутствуют или пустые параметры кнопки в сообщении, когда она обязательна',
            //205
            'REQUIRED_MESSAGE_BUTTON_CAPTION' => 'Отсутствует или пустой параметр текста на кнопке в сообщении', //206
            ...
            //300
            'INVALID_REQUEST' => 'Неверный запрос, проверьте его структуру и корректность данных', //301
            'INVALID_TOKEN' => 'Неверный токен аутентификации', //302
            'INVALID_MESSAGE_SENDER' => 'Неверный отправитель сообщения', //303
            'INVALID_START_TIME' => 'Неверная дата отложенной отправки сообщения', //304
            ...
            //306
            'INVALID_MESSAGE_ID' => 'Недопустимое значение параметра message_id, неверный формат', //400
            'NOT_ALLOWED_MESSAGE_SENDER' => 'Не разрешённый отправитель для текущего пользователя', //401
            ...
            //402
            'NOT_ALLOWED_MESSAGE_IMAGE' => 'Недопустимый тип файла изображения', //403
            ...
            //405
            'NOT_ALLOWED_RECIPIENTS_LIMIT' => 'Недопустимое количество получателей', //406
            ...
            //407
            'NOT_ALLOWED_RECIPIENT_DUPLICATE' => 'Получатель уже присутствует в рассылке, дубликаты игнорируются', //408
            ...
            //412
            'NOT_ALLOWED_MESSAGE_TEXT' => 'Текст содержит запрещённые фрагменты', //413
            'NOT_ALLOWED_MESSAGE_TEXT_LENGTH' => 'Превышена допустимая длина текста сообщения', //414
            ...
            //502
            'FAILED_PARSE_BODY' => 'Не удалось распознать тело запроса (неверный формат)', //503
            'FAILED_SMS_SEND' => 'Не удалось отправить SMS сообщение', //504
            'FAILED_VIBER_SEND' => 'Не удалось отправить Viber сообщение', //505
            'FAILED_SAVE_IMAGE' => 'Не удалось сохранить изображение', //800
            ...
            //801
            'SUCCESS_MESSAGE_SENT' => 'Сообщения успешно отправлены', //802
