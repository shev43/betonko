            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="width:100%;">
                <tr>
                    <td style="text-align: center;padding-left:20px;padding-right:20px;padding-top:20px;padding-bottom:50px;" align="center">
                        <a href="https://www.betonko.com.ua/">
                            <img src="https://www.betonko.com.ua/img/emails/themes/subscribe/logo-top.png"  style="width:auto;height: 36px;">
                        </a>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: left;padding-left:20px;padding-right:20px;padding-top:20px;padding-bottom:50px;" align="left">
                        ...
                        <h4 style="margin-top: 30px;margin-bottom: 40px;">Недавно вы запросили сброс пароля вашей учетной записи в betonko.</h4>
                ...
                <tr>
                    <td align="center" style="text-align: center;padding-top: 20px;padding-bottom: 20px;background-color: #2C2E2F">
                        <table width="100%" align="left" style="text-align: left">
                            <td style="width:50%;text-align: left;padding-left:20px;padding-right:20px;" align="left" valign="top">
                                <a href="https://www.betonko.com.ua/">
                                    <img src="https://www.betonko.com.ua/img/emails/themes/subscribe/logo-bottom.png"  style="width:auto;height:36px;">
                                </a>
                            </td>
                            <td style="text-align: left;padding-left:20px;padding-right:20px;" align="left">
                                ...
                                <div style="margin-top: 30px;"><a href="mailto:support@betonko.com.ua" style="display: flex;text-decoration: none;color:#ffffff;">Зворотній зв’язок</a></div>
                            </td>
                        </table>
                    </td>
                </tr>
