    ...
    <main class="main page">
        <div class="container">
            <section class="sign_up">
                ...
                <form action="{{ route('business::profile.register', ['lang'=>app()->getLocale()]) }}" method="post">
                    @csrf
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input id="first_name" name="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" placeholder="Ваше ім’я" value="{{ old('first_name') }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="last_name">Ваше прізвище:</label>
                                <input id="last_name" name="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" placeholder="Ваше прізвище" value="{{ old('last_name') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="form-pass">
                                    <input class="form-pass-checkbox-confirm" type="checkbox" id="password_confirmation" value="0">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    ...
                                    <div class="form-check-text">Я погоджуюся з <a href="#"><b>Умовами використання</b></a> та
                                        <a href="#"><b>Політикою конфіденційності</b></a></div>
                                </div>
                            ...
                            <div class="form-group text-center">
                                <button class="btn btn-default" type="submit">Надіслати заявку</button>
                            </div>
                        </div>
                    </div>
                </form>
