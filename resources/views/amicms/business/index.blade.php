            ...
            <div>
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th width="100">#</th>
                        <th>Компанія</th>
                        <th width="100" class="text-center">Заводов / Продуктів</th>
                    ...
                    @foreach($business_array as $business)
                        <tr>
                            ...
                            <td class="text-center">
                                <span>{{ count($business->factories) }} / {{ count($business->products) }}</span>
                            </td>
                            <td class="text-center">
                                <span>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        @if($business->deleted_at == null)
                                            <li>
                                                <a href="{{ route('amicms::business.reports.visitors', ['business_id'=>$business->id]) }}" class="dropdown-item">
                                                    <div class="d-flex align-items-center">
                                            ...
                                            <li>
                                                <a href="{{ route('amicms::business.edit', ['business_id'=>$business->id]) }}" class="dropdown-item">
                                                    <div class="d-flex align-items-center">
