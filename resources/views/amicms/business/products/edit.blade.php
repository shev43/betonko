    ...
    <div class="card">
        <div class="container-fluid">
            <div class="row content-min-height">
                ...
                <div class="col">
                    <div class="card-body">
                        <form action="{{ route('amicms::business.products.update', ['business_id'=>$business_id, 'product_id'=>$product->id]) }}" method="post">
                            @csrf
                                ...
                                <div class="col-md">
                                    <table class="table">
                                                ...
                                                <select class="selectpicker @error('factories') is-invalid @enderror" id="factories" name="factories" data-style="form-control" title="Виберіть завод">
                                                    @foreach($product->factories as $factory_key=>$factory)
                                                        <option value="{{ $factory->id }}"
                                                            {{old('factories.'.$factory_key.'', $product->factories_id) == $factory->id ? 'selected="selected"' :''}}>
                                                            {{ $factory->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-3">
                                                <input type="number" class="form-control {{$errors->has('price') ? 'is-invalid' : ''}}" name="price" min="1" max="9999" step="1" value="{{ old('price', $product->price) }}" placeholder="Виберіть ціну" autocomplete="off">
                                                @if($errors->has('price'))
