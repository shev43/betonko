                ...
                <table class="table">
                    ...
                    @foreach($orders_array as $order)
                        <tr>
                            ...
                            <td>
                                <div class="text-dark fw-bold">{{ $order->client->first_name }} {{ $order->client->last_name }}</div>
                                <div class="text-muted mt-2">{{ $order->client->phoneFormatted }}</div>
                                <div class="text-muted mt-2">{{ $order->client->email }}</div>
