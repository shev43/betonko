                ...
                <div class="col-12 col-md-8">
                    <div class="row align-items-start subscribe-item-top-body">
                        ...
                        <div class="col-12 buttons">
                            <button class="btn btn-default price-mount" data-toggle="modal" data-target="#authModal">Отримати за {{ config('subscription.price_mount') }} грн/місяць</button>
                            <button class="btn btn-default price-year" data-toggle="modal" data-target="#authModal">Отримати за {{ config('subscription.price_year') }} грн/рік</button>
