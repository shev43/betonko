<div class="modal fade" id="reviewServiceModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        ...
                        <div class="col-12">
                                <div class="form-group">
                                    <select class="selectpicker" name="question[]" id="" data-style="form-control" data-title="Що нам покращити?" multiple required>
                                        <option value="q1">Вопрос 1</option>
                                        <option value="q2">Вопрос 2</option>
                                        <option value="q3">Вопрос 3</option>
                                        <option value="q4">Вопрос 4</option>
                                        <option value="q5">Вопрос 5</option>
                                    </select>
                                </div>
                                <div class="form-group">
    ...
    <script>
        ...
        let url_discard = '{{ route('review.discard', ['user_id'=>request()->user()->id]) }}'
