...
<div id="map-warning" class="alert alert-warning alert-dismissible fade show d-none" role="alert">
...
@if($errors->has('marker_latitude') || $errors->has('marker_longitude'))
    <small class="form-text text-danger"> Вкажіть розташування заводу на карті (клікнувши у необхідному місці) </small>
@endif
