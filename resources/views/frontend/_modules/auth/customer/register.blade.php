<div class="form-step step-1">
    <form method="post" action="{{route('customer::profile.register.sms', ['lang'=>app()->getLocale()])}}" id="send-register-sms">
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="form-check">
                ...
                <div class="form-check-text">Погоджуюся з
                    <a href="{{ route('frontend::rules', ['lang'=>app()->getLocale()]) }}"><b>Умовами використання</b></a> та
        ...
        <div class="form-group">
            ...
            <button type="button" class="btn btn-border_dark go-to-login">Увійти</button>
        </div>
    </form>
</div>
