...
@section('content')
    <nav class="container mt-3" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Створення тендера</li>
        </ol>
    </nav>
            ...
            @if(!request()->all())
                <form>
                    ...
                    <div class="text-center">
                        <button class="btn btn-default" type="submit">Вибрати</button>
                    </div>
                </form>
            @else

                <form id="customerRequest" action="{{ route('customer::tender.store', ['lang'=>app()->getLocale()]) }}" method="post" class="order-form">
                    @csrf
                    <input name="is_tender" type="hidden" value="1">
                    <input name="mark" type="hidden" value="{{ request()->get('mark') ?? '' }}">
                    <input name="class" type="hidden" value="{{ request()->get('class') ?? '' }}">
                    <input name="frost_resistance" type="hidden" value="{{ request()->get('frost_resistance') ?? '' }}">
                    <input name="water_resistance" type="hidden" value="{{ request()->get('water_resistance') ?? '' }}">
                    <input name="mixture_mobility" type="hidden" value="{{ request()->get('mixture_mobility') ?? '' }}">
                    <input name="winter_supplement" type="hidden" value="{{ request()->get('winter_supplement') ?? '' }}">
                                ...
                                <div class="properties">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>Марка</td>
                                            <td>
                                                <span><b>{{ Config::get('product.mark.' . request()->get('mark')) ?? 'н/в' }}</b></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>Клас</td>
                                            <td>
                                                <span><b>{{ Config::get('product.class.' . request()->get('class')) ?? 'н/в' }}</b></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <span><b>{{ Config::get('product.frost_resistance.' . request()->get('frost_resistance')) ?? 'н/в' }}</b></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>Водостійкість</td>
                                            <td>
                                                <span><b>{{ Config::get('product.water_resistance.' . request()->get('water_resistance')) ?? 'н/в' }}</b></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <span><b>{{ Config::get('product.mixture_mobility.' . request()->get('mixture_mobility')) ?? 'н/в' }}</b></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <span><b>{{ Config::get('product.winter_supplement.' . request()->get('winter_supplement')) ?? 'н/в' }}</b></span>
                                            </td>
                                        </tr>
                                ...
                                <div class="order-price">
                                    ...
                                    <div class="range">
                                        ...
                                        <div class="order-price-range">
                                            <input type="number" class="form-control start" id="start" name="min_price"
                                                   value="1"> <span>—</span>
                                            <input type="number" class="form-control end" id="end" name="max_price"
                                                   value="9999">
                                        </div>
                                    ...
                                    <div class="order-price-count mt-4">
