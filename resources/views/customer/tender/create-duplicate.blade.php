...
@section('content')
    <nav class="container mt-3" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Створення дубліката тендера</li>
        </ol>
    </nav>
                                ...
                                <div class="properties">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>Марка</td>
                                            <td>
                                                <span><b>{{ Config::get('product.mark.' . $order->mark) ?? 'н/в' }}</b></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>Клас</td>
                                            <td>
                                                <span><b>{{ Config::get('product.class.' . $order->class) ?? 'н/в' }}</b></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <span><b>{{ Config::get('product.frost_resistance.' . $order->frost_resistance) ?? 'н/в' }}</b></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>Водостійкість</td>
                                            <td>
                                                <span><b>{{ Config::get('product.water_resistance.' . $order->water_resistance) ?? 'н/в' }}</b></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <span><b>{{ Config::get('product.mixture_mobility.' . $order->mixture_mobility) ?? 'н/в' }}</b></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <span><b>{{ Config::get('product.winter_supplement.' . $order->winter_supplement) ?? 'н/в' }}</b></span>
                                            </td>
                                        </tr>
                                ...
                                <div class="order-price">
                                    ...
                                    <div class="range">
                                        ...
                                        <div class="range-slider"
                                             ...
                                             data-start="@if($order->min_price){{ $order->min_price }}@else @getMinPrice() @endif"
                                             data-end="@if($order->max_price){{ $order->max_price }}@else @getMaxPrice() @endif"
                                             data-step="1"></div>
