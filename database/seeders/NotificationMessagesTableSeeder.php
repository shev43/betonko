    ...
    public function run() {
        $array = [
            [
                ...
                'message' => "<b>Вітаємо!</b><br>Ви зареєструвались як покупець на Betonko!",
                'language' => 'ua',
            ...
            [
                ...
                'message' => "<b>Вітаємо!</b><br>Ви зареєструвались як продавець на Betonko!",
                'language' => 'ua',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s")
            ],
            ...
            [
                'action' => 'business.factory.adding',
                'message' => "<b>Додано завод!</b><br>З'явився перший завод, щоб додати наступні заводи спробуйте <b>план \"Експертний\"</b>",
                'language' => 'ua',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s")
            ],
            [
                'action' => 'business.contact.adding',
                'message' => "Додано нову контактну особу",
                'language' => 'ua',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s")
            ],
            [
                'action' => 'business.contact.edited',
                'message' => "Змінено контактну особу",
                'language' => 'ua',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s")
            ],
            [
                'action' => 'business.contact.deleted',
                'message' => "Видалено контактну особу",
                'language' => 'ua',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s")
            ],
